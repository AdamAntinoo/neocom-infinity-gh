...
class AbstractValidationHandler {
    ...
    validateAtHash(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let /** @type {?} */ tokenHash = yield this.calcHash(params.accessToken, hashAlg); // sha256(accessToken, { asString: true });
...
class OAuthService extends AuthConfig {
    ...
    processIdToken(idToken, accessToken) {
        ...
        if (issuedAtMSec - tenMinutesInMsec >= now ||
            ...
            const /** @type {?} */ err = 'Token has expired';
            console.error(err);
            console.error({
                now: now,
...
class JwksValidationHandler extends AbstractValidationHandler {
    constructor() {
        ...
        this.cyptoObj = window.crypto || (/** @type {?} */ (window)).msCrypto;
        this.textEncoder = new (/** @type {?} */ (window)).TextEncoder();
    }
    /**
     * @param {?} params
     * @param {?=} retry
    ...
    validateSignature(params, retry = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const /** @type {?} */ cyptokey = yield this.cyptoObj.subtle.importKey('jwk', /** @type {?} */ (key), alg, true, ['verify']);
            const /** @type {?} */ isValid = yield this.cyptoObj.subtle.verify(alg, cyptokey, this.textEncoder.encode(sig), this.textEncoder.encode(body));
            if (isValid) {
    ...
    calcHash(valueToHash, algorithm) {
        return __awaiter(this, void 0, void 0, function* () {
            const /** @type {?} */ valueAsBytes = this.textEncoder.encode(valueToHash);
            const /** @type {?} */ resultBytes = yield this.cyptoObj.subtle.digest(algorithm, valueAsBytes);
