...
export class ESIConfigurationSingularity {
  ...
  public static SCOPE = "esi-assets.read_assets.v1 esi-assets.read_corporation_assets.v1 esi-industry.read_character_jobs.v1 esi-planets.manage_planets.v1 esi-contracts.read_character_contracts.v1 esi-fittings.read_fittings.v1 esi-fittings.write_fittings.v1";
  public static AUTHORIZE_URL = ESIConfigurationSingularity.AUTHORIZATION_SERVER + "oauth/authorize";
  public static ACCESS_TOKEN_RESOURCE = ESIConfigurationSingularity.AUTHORIZATION_SERVER + "oauth/token";
