...
import { IContainerController } from './IContainerController.interface';

export interface IViewer extends IContainerController{
  getViewer(): IViewer;
  // notifyDataChanged(): void;
  // applyPolicies(_entries: INode[]): INode[];
}
