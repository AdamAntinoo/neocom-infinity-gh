...
describe('PANEL PilotPublicDataPanelComponent [Module: SHARED]', () => {
   ...
   describe('Code Coverage Phase [getters]', () => {
      it('getPilotIcon.success: validate the pilot icon field', () => {
         const expected = isolationService.generateRandomString(12);
         pilot.url4Icon = expected;
         component.pilot = pilot;
         const obtained = component.getPilotIcon();
         expect(obtained).toBe(expected);
      });
      it('getPilotIcon.failure: validate the pilot icon field', () => {
         const obtained = component.getPilotIcon();
