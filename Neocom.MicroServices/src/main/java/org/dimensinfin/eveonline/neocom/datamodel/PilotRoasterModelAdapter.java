...
public class PilotRoasterModelAdapter implements IModelAdapter {
	// - S T A T I C - S E C T I O N ..........................................................................
	private static Logger									logger					= Logger.getLogger("PilorRoasterModelAdapter");
	...
	public PilotRoasterModelAdapter(DataSourceLocator locator, String login) {
		_locator = locator;
		this.login = login;
	}

	public PilotRoasterModelAdapter addParameter(final String name, final int value) {
		_parameters.put(name, Integer.valueOf(value));
		return this;
	}

	public PilotRoasterModelAdapter addParameter(final String name, final long value) {
		_parameters.put(name, Long.valueOf(value));
		return this;
	}

	public PilotRoasterModelAdapter addParameter(final String name, final String value) {
	...
	public RootNode collaborate2Model() {
		logger.info(">> [PilotRoasterModelAdapter.collaborate2Model]");
